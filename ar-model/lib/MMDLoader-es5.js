 ...
 *  - THREE.OutlineEffect
 *
 *	这个加载器加载并解析 pmd/pmx 和 VMD二进制文件，然后为3.js创建网格。
 * This loader loads and parses PMD/PMX and VMD binary files then creates mesh for Three.js.
 *
 *	pmd/pmx是一种模型数据格式，VMD是MMD(Miku Miku舞蹈)中使用的一种运动数据格式。
 *	PMD/PMX is a model data format and VMD is a motion data format used in MMD(Miku Miku Dance).
 *
 *
...
var MMDParser = __webpack_require__(1);
